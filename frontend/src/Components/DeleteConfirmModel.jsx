...
function DeleteConfirmModel({ toggleModal, onDelete, modalOpen }) {
    return (
        <div id="popup-modal" className={`fixed top-0 right-0 left-0 z-50 bg-black/50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full ${modalOpen ? '' : 'hidden'}`}>
